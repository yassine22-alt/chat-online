...
.home {
  ...
  position: relative;
  overflow: hidden;
  background: linear-gradient(to bottom, rgba(0, 123, 255, 0.6), #ffffff);
  padding-top: 130px;
}
...
.bubble:nth-child(9) { left: 90%; width: 75px; height: 75px; animation-duration: 6s; }
